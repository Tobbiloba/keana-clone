...
const Banner = () => {
    ...
    return (
        <div className='px-[1.5rem] bg-slate-700 w-[100vw] pt-[5rem] pb-[10rem] md:flex md:px-[4rem] lg:justify-center lg:gap-[10%]  flex-row justify-between '>
            <div data-aos="fade-up" className='rounded-2xl  overflow-hidden md:w-[42.5%] lg:w-[20rem]'>
                <img src={people} className='' />
            </div>
            <div data-aos="fade-right" className='mt-[2.5rem] md:w-[45%]  lg:flex lg:flex-col justify-center'>
