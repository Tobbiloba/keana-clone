...
const Footer = () => {
    return (
        <div className='bg-slate-800 w-[100vw] px-[2rem] py-[3rem] flex flex-row justify-between'>
            ...
            <div className='gap-[3rem] flex flex-col'>
                ...
                <div className=''>
                    <div className='text-white text-[14px] font-mono'>
                        ...
                        <h1>Mail: <a href="info@keana.io" className='text-slate-300 '>info@keana.io</a></h1>
                    </div>
