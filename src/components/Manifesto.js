...
const Manifesto = () => {
    return (
        <div className='py-[3rem] px-[1.5rem] md:px-[10%]'>
            ...
            <div className='py-[4rem] flex justify-end'>
                ...
                <p className='w-[70%] md:w-[55%] lg:w-[80%] text-green-500 font-mono text-xl'>But unfortunately, it also leads to more handlers being involved in the now decentralised distribution chain, clogging up the current system.</p>
            ...
            <p className='py-[4rem] text-green-500 font-mono font-bold text-xl lg:text-center'>Most essential to all this, is the fact that we embrace a human approach.</p>
