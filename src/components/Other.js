...
const Other = () => {
    return (
        <div className='w-[100vw] bg-slate-500 lg:items-center z-30 lg:flex flex-row lg:h-[650px] md:flex md:justify-end md:h-[35rem]'>
            {/* <div className='hidden lg:flex  w-[45%] overflow-hidden'>

            </div> */}
            {/* <div className='absolute left-0 overflow-hidden w-[60vw] md:w-[40vw] hidden lg:flex md:flex md:h-[35rem]'>
                <img src="https://keana.io/assets/vector-nodes-green.937a46d6.svg" alt="image" className='max-w-none relative md:w-[75rem]' />
            </div> */}
            <div className=' px-[2rem] z-10 md:bg-cyan-100 pt-[2.5rem] md:w-[70%] md:h-[35rem] lg:w-[45%] h-fit '>
                <h1 className='text-slate-700 text-4xl font-bold font-mono '>More handlers,<br />more problem</h1>
                <p className='mt-6 text-[18px] leading-8 text-slate-300 '>
            ...
            <div className='flex lg:hidden mt-4 md:hidden w-[100vw]'>
